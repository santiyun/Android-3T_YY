...
public class SplashActivity extends BaseActivity {
    ...
    private void initSDK() {
        ...
        // 6.使用YY美颜，需要YY来提供视频采集，所以需要启用三体外部视频源功能。暂只有主播角色可以使用美颜，副播暂不支持美颜，
        // 是因为demo界面展示原因，改动工作量太大。
        if (mHostBT.isChecked()) {
            mTTTEngine.setExternalVideoSource(true, false, false);
        } else {
            mTTTEngine.setExternalVideoSource(false, false, false);
        }
    }
