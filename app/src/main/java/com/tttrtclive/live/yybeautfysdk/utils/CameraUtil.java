...
public class CameraUtil {
    ...
    public void openCamera(int cameraIndex, int width, int height, SurfaceTexture surfaceTexture) {
        ...
        try {
            ...
            mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class), width, height, new Size(width, height));
            if (mPreviewSize == null) {
                mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class), height, width, new Size(height, width));
            }
    ...
    public void touchFocus(PointF pos, int size) {
        ...
        MeteringRectangle[] rectangle = new MeteringRectangle[] { new MeteringRectangle(meterRect, MeteringRectangle.METERING_WEIGHT_MAX) };
